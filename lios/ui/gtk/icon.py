...
stock_icon_dict = { _("_File") :"edit-copy",
					...
					_("Import"):"gtk-open",
					_("Export"):"gtk-save",
					_("Apply-From-Cursor"):"gtk-find-and-replace",
					_("Apply-Entire"):"gtk-find-and-replace",
					_("Train-Tesseract"):"system-upgrade",
					_("Spell-Check"):"gtk-spell-check",
					_("Start/Stop-Reader"):"gtk-execute",
